...
- Update packages + project clean

### Fixed

- Deprecation warning in development server code

## [v0.6.0] - 2026-02-01

### Changed

- Highlight all text in input on focus for better UX

## [v0.5.1] - 2026-01-31

### Fixed

- Header color to span into status bar in iOS
...
- Theme color meta tag for iOS

### Changed

- Remove complexity when serving cache in service worker
...
- .editorconfig which confirms to prettier format
